...
var CharacterCollection = /** @class */ (function (_super) {
    ...
    CharacterCollection.prototype.compare = function (leftHandIndex, rightHandIndex) {
        return (this.data[leftHandIndex].toLowerCase() >
            this.data[rightHandIndex].toLowerCase());
    };
    CharacterCollection.prototype.swap = function (leftHandIndex, rightHandIndex) {
        var characters = this.data.split("");
        var leftHand = characters[leftHandIndex];
        characters[leftHandIndex] = characters[rightHandIndex];
        characters[rightHandIndex] = leftHand;
        this.data = characters.join("");
    };
    CharacterCollection.prototype.sort = function () {
